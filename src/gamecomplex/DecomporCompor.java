...
public class DecomporCompor extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DecomporCompor frame = new DecomporCompor();
	 ...
	 * Create the frame.
	 */
	public DecomporCompor() {
		setAlwaysOnTop(true);
		setBackground(Color.BLACK);
		setTitle("PotterManiacos | Decompor & Compor");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DecomporCompor.class.getResource("/gamecomplex/pp.jpg")));
		setResizable(false);
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				if(e.getKeyCode() == KeyEvent.VK_ENTER ){
					...
					for (int i = 1; i <= palavra2.length(); i++) {
					    textArea.append(palavra2.substring(0, i));
					    textArea.append("\n");
		...
		JLabel lblCompor = new JLabel("DECOMPOR & COMPOR");
