			...
			public void keyPressed(KeyEvent e) {
				...
				if(e.getKeyCode() == KeyEvent.VK_ENTER ){	
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("bamboé")) {
								bamboeCheck = true;
								}else {
								bamboeCheck = false;
								}
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("dragão")) {
								dragaoCheck = true;
								}else {
								dragaoCheck = false;
								}
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("estupefaça")) {
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("natália")) {
								nataliaCheck = true;
								}else {
								nataliaCheck = false;
								}
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("transfiguração")) {
							...
							if(!palavra.equalsIgnoreCase("trato das criaturas mágicas")) {
								tratoDCMCheck = true;
								}else {
								tratoDCMCheck = false;
								}
					...
					*/
							...
							if(!palavra.equalsIgnoreCase("unicórnio")) {
								unicornioCheck = true;
								}else {
								unicornioCheck = false;
								}
							boolean uediuosiCheck = true;
							if(!palavra.equalsIgnoreCase("uediuósi")) {
								uediuosiCheck = true;
								}else {
								uediuosiCheck = false;
								}
					...
					*/
					...
					//================================================================================	
								        	...
								        	textArea.append("atália McDonald");	
								        	nataliaCheck = false;
					...
					//================================================================================	
								        	...
								        	textArea.append("rato das Criaturas Mágicas");	
								        	tratoDCMCheck = false;
					...
					//================================================================================	
								        	...
								        	textArea.append("nicórnio");	
								        	unicornioCheck = false;
								        }else if (uediuosiCheck == true && (palavra.charAt(i)) == 'U') {
								        	textArea.append("ediuósi");	
								        	uediuosiCheck = false;
